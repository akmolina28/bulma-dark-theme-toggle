  ...
  <div class="container">
    ...
    <section class="section" id="content">
      ...
      <div class="content">
        ...
        <p>
          ...
          cursus venenatis. Suspendisse potenti. Etiam mattis sem rhoncus lacus
    ...
    <section class="section" id="notifications">
      ...
      <div class="columns is-multiline">
        <div v-for="modifier in pageModifiers(7)" :key="modifier" class="column is-half">
          <div :class="`notification ${modifier == '' ? '' : 'is-' + modifier}`">
    ...
    <section class="section" id="progress">
      ...
      <hr />
      <progress
        v-for="modifier in pageModifiers(7)"
        :key="modifier"
        :class="`progress ${modifier == '' ? '' : 'is-' + modifier}`"
        max="100"
        value="15"
      >
        15%
...
<section class="section" id="tag">
  ...
  <hr>
  <div class="tags">
    <span v-for="modifier in pageModifiers(10)" :key="modifier" :class="`tag ${modifier === '' ? '' : 'is-' + modifier}`"> 
      {{modifier === '' ? 'tag' : modifier | capitalize}} 
    </span>
...
<section class="section" id="hero">
  ...
  <hr>
  <section v-for="(modifier) in pageModifiers(12)" :key="modifier">
    <div>
...
<section class="section" id="message">
  ...
  <hr>
  <div class="columns is-multiline">
    <div v-for="modifier in pageModifiers(11)" :key="modifier" class="column is-half">
      <article :class="`message ${modifier === '' ? '' : 'is-' + modifier}`">
        <div class="message-header">
          <p v-if="modifier === ''">
            Message
          </p>
...
<section class="section" id="modal">
  ...
  <hr>
  <a class="button is-primary is-large" data-target="#myModal" @click="modalActive = true">Launch example modal</a>
  <div :class="`modal ${modalActive ? 'is-active' : ''}`" id="myModal">
    <div class="modal-background"></div>
    <div class="modal-card">
      <header class="modal-card-head">
        <p class="modal-card-title">Modal title</p>
        <button class="delete" @click="modalActive = false"></button>
      </header>
...
<section class="section" id="navbar">
  ...
  <hr>
  <div v-for="modifier in pageModifiers(11)" :key="modifier">
    <nav :class="`navbar ${modifier === '' ? '' : 'is-' + modifier}`">
      <div class="navbar-brand">
...
export default {
  ...
  methods: {
    pageModifiers(count) {
      if (count) {
        return this.allPageModifers.filter((modifier, index) => index < count);
      }
